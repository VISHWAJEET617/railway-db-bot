...
from tgbot.handlers.proxy import setproxy, checkproxy, myproxy, proxy_guide, proxy_callback
...
def main():
    ...
    app.add_handler(CommandHandler("proxy_guide", proxy_guide))
    ...
    app.add_handler(CallbackQueryHandler(proxy_callback,        pattern="^setproxy_help$|^recheck_proxy$|^myproxy_recheck$|^myproxy_delete$|^show_proxy_guide$"))
    ...
    async def post_init(application):
        await application.bot.set_my_commands([
            ...
            BotCommand("proxy_guide", "How to get & set a proxy"),
